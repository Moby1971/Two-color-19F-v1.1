function dicom_header = generate_dicomheader_19F(parameters,i,dimx,dimy,dcmid)
...
aspectratio = parameters.SMX/parameters.SMY;  % aspect ratio, needs to be checked
...
dcmhead.ImagedNucleus = parameters.nucleus;
