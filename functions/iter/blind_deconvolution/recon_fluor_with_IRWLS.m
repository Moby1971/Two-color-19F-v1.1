...
%     figure(72); imshow(X,[]);colormap jet; title('linear convolution operator X')
...
%     validregion=[Spectrum1,Spectrum1]~=0;
...
params.export=0
params.fignumber=50
params.threshold=0.22
params.Alpha=0.3;

params.slicerange=63
params.maxfactor=2;
params.minfactor=3;
...
%% CG BOTH
params.slicerange=90
params.maxfactor=2;
params.fignumber=55
CreateOverlayImage(protonimage,squeeze(Recon_originalFOV{1,1}),squeeze(Recon_originalFOV{1,2}),params)


 %% Create Blue Ovelray Image 
 params.fignumber=64

I3_originalFOV=I3(33:96,33:96,33:96); 
I3_originalFOV=fft3_meas(I3_originalFOV);
I3_originalFOV=padarray(I3_originalFOV,[32 32 32]);
I3_originalFOV=ifft3_meas(I3_originalFOV);
params.orientation='cor'
params.threshold=0.1

params.slicerange=64
params.maxfactor=20
params.minfactor=10000;

CreateOverlayImage(protonimage,[],I3_originalFOV,params)

%%
params.fignumber=61

I1_originalFOV=I1(33:96,33:96,33:96); 
I1_originalFOV=fft3_meas(I1_originalFOV);
I1_originalFOV=padarray(I1_originalFOV,[32 32 32]);
I1_originalFOV=ifft3_meas(I1_originalFOV);
params.orientation='cor'

params.slicerange=47
params.maxfactor=20
params.minfactor=10000;

CreateOverlayImage(protonimage10,[],I1_originalFOV,params)
